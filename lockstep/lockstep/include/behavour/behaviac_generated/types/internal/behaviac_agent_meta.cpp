...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(51165953u);
			...
			// lockstep::AIAgent
			meta = BEHAVIAC_NEW AgentMeta(2100513983u);
			AgentMeta::GetAgentMetas()[2286703575u] = meta;
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_lockstep_AIAgent_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<lockstep::AIAgent>("lockstep::AIAgent");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<lockstep::AIAgent>("lockstep::AIAgent");
