...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(622566950u);
			...
			// AIAgent
			meta = BEHAVIAC_NEW AgentMeta(3552854483u);
			AgentMeta::GetAgentMetas()[3672729745u] = meta;
			meta->RegisterMemberProperty(3082280176u, BEHAVIAC_NEW CMemberProperty< int >("mMoveDir", Set_AIAgent_mMoveDir, Get_AIAgent_mMoveDir));
			meta->RegisterMethod(3159047554u, BEHAVIAC_NEW CAgentMethodVoid_1<int>(FunctionPointer_AIAgent_DoHMove));
			meta->RegisterMethod(262934388u, BEHAVIAC_NEW CAgentMethod< int >(FunctionPointer_AIAgent_GetFaceEnermyX));
			meta->RegisterMethod(1666360340u, BEHAVIAC_NEW CAgentMethod< int >(FunctionPointer_AIAgent_GetState));
			meta->RegisterMethod(4177614915u, BEHAVIAC_NEW CAgentMethod< int >(FunctionPointer_AIAgent_GetX));
